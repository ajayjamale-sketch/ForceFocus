...
import { Shield, ChevronRight, Download, Mail, FileText, Globe, Lock, Eye, Trash2, RefreshCw, UserCheck } from "lucide-react";
...
const rights = [
  {
    ...
    actionFn: () => toast.success("Data export request submitted. You'll receive your data within 30 days."),
  },
  {
    icon: RefreshCw,
  ...
  },
  {
    ...
    actionFn: () => toast.info("Account deletion request initiated. Our team will contact you within 72 hours."),
  },
  {
    icon: Lock,
    ...
    actionFn: () => toast.success("Processing restriction request received."),
  },
  {
    icon: Download,
    ...
    actionFn: () => toast.success("Your data export (JSON + CSV) is being prepared."),
  },
  {
    icon: UserCheck,
    ...
    actionFn: () => toast.success("Your objection has been logged. We'll respond within 30 days."),
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-[#0A0F1E] pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="font-display text-5xl font-bold text-white mb-4">GDPR Compliance</h1>
          ...
          <p className="text-gray-500 text-sm mt-4">Last updated: May 20, 2026 · Effective: May 25, 2018</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          {/* Quick Nav */}
          <nav className="bg-muted/50 border border-border rounded-2xl p-5 mb-12">
            ...
            <div className="grid sm:grid-cols-2 gap-1.5">
              {[
                ...
                <a key={item} href={`#${item.toLowerCase().replace(/\s+/g, "-")}`} className="flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400 hover:underline">
          ...
          <div id="your-rights" className="mb-12 scroll-mt-24">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {rights.map(({ icon: Icon, title, article, description, action, actionFn, href }) => (
                <div key={title} className="bg-card border border-border rounded-2xl p-5 card-hover">
                  ...
                  {href ? (
                    <Link to={href} className="text-xs text-blue-600 dark:text-blue-400 font-medium hover:underline inline-flex items-center gap-1">
                      {action} <ChevronRight className="w-3 h-3" />
                    </Link>
                  ) : (
                    <button onClick={actionFn} className="text-xs text-blue-600 dark:text-blue-400 font-medium hover:underline inline-flex items-center gap-1">
                      {action} <ChevronRight className="w-3 h-3" />
                    </button>
                  )}
                </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm mb-5">
                <div>
                  ...
                  <a href="mailto:dpo@forcefocus.app" className="text-blue-600 dark:text-blue-400 hover:underline">dpo@forcefocus.app</a>
                </div>
                <div>
              ...
              <button
                onClick={() => toast.success("GDPR request submitted. We'll respond within 30 days.")}
          ...
          <div className="mt-12 pt-8 border-t border-border flex flex-wrap gap-4">
            ...
            <Link to="/cookie-policy" className="text-sm text-blue-600 dark:text-blue-400 hover:underline">Cookie Policy</Link>
          </div>
        </div>
      </section>
